                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    @if(count($about_us_experties_list) == 1)

                                    @foreach($about_us_experties_list as $all_back_video)

 <form class="custom-validation" action="{{ route('admin.about_us_experties.update') }}" method="post" enctype="multipart/form-data">
    @csrf
...
@endforeach
                                    @else
                                    <form class="custom-validation" action="{{ route('admin.about_us_experties.store') }}" method="post" enctype="multipart/form-data">
                                        @csrf
                                           <div class="row">
                                            <div class="form-group col-md-12 col-sm-12">
                                                <label for="name">Description</label>
