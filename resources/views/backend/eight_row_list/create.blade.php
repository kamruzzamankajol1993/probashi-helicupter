...
@section('title')
Add Client Say Information | {{ $ins_name }}
@endsection
...
<div class="row">
    <div class="col-12">
        <div class="page-title-box d-flex align-items-center justify-content-between">
            <h4 class="mb-0">Add Client Say Information</h4>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="form-group col-md-12 col-sm-12">
                                        ...
                                        <input type="text" class="form-control form-control-sm" id="name" name="image"  placeholder="Enter Address">
