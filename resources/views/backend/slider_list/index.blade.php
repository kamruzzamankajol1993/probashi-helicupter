...
<div class="row">
                        <div class="col-sm-6">
                            <div class="float-right d-md-block">
                                <div class="dropdown">
                                @if (Auth::guard('admin')->user()->can('bannerAdd'))
...
<div class="table-responsive">
    ...
    style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                ...
                                <td><img src="{{ asset('/') }}{{ $user->image }}" style="height:130px;"/></td>
                                    ...
                                    <td>
                                      @if (Auth::guard('admin')->user()->can('bannerUpdate'))
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form class="custom-validation" action="{{ route('admin.banner_List.update') }}" method="post" enctype="multipart/form-data">
                              @csrf
                                <div class="row">
...
@endif
                                  ...
                                  @if (Auth::guard('admin')->user()->can('bannerView'))
...
<button   type="button" class="btn btn-danger waves-light waves-effect  btn-sm" onclick="deleteTag({{ $user->id}})" data-toggle="tooltip" title="Delete"><i class="fas fa-trash-alt"></i></button>
                    <form id="delete-form-{{ $user->id }}" action="{{ route('admin.banner_List.delete',$user->id) }}" method="POST" style="display: none;">
  ...
  <div class="modal fade bs-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="custom-validation" action="{{ route('admin.banner_List.store') }}" method="post" enctype="multipart/form-data">
                    @csrf
                       <div class="row">
