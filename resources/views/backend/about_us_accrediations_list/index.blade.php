...
<div class="row">
    <div class="col-12">
        <div class="page-title-box d-flex align-items-center justify-content-between">
            <h4 class="mb-0">Accrediations </h4>
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    @if(count($about_us_accrediations_list) == 1)

                                    @foreach($about_us_accrediations_list as $all_back_video)

 <form class="custom-validation" action="{{ route('admin.about_us_accrediations.update') }}" method="post" enctype="multipart/form-data">
    @csrf
...
@endforeach
                                    @else
                                    <form class="custom-validation" action="{{ route('admin.about_us_accrediations.store') }}" method="post" enctype="multipart/form-data">
                                        @csrf
                                           <div class="row">
                                            <div class="form-group col-md-12 col-sm-12">
                                                <label for="name">Description</label>
