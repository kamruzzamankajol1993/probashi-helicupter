        ...
        <div
            ...
            <div class="  w-full h-[400px]">
                ...
                <div class="card-body">
                    ...
                    <form class="w-full max-w-lg"  enctype="multipart/form-data"  id="form" method="post" action="{{route('registrationToCheckout')}}">
                        @csrf
            ...
            <div class="  w-full h-[400px]">
                ...
                <div class="card-body">
                    ...
                    <form class="w-full max-w-lg" id="form" method="post" action="{{route('loginToCheckout')}}">
                        @csrf
                                            <input value="offer" name="order_type" type="hidden" >
