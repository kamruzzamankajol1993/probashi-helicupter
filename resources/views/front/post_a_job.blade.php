...
@csrf
                    <input value="service" name="order_type" type="hidden" >
    ...
    <option value="Online Payment">Online Payment</option>
            ...
            <div class="  w-full h-[400px]">
                ...
                <div class="card-body">
                    ...
                    <p class="mt-2"><span class="text-md font-bold text-[var(--color-primary)]">Service Name </span>: {{$allOffers->title}}</p>

                    <p class="text-xl font-bold "><span class="text-md font-bold text-[var(--color-primary)]">Service Price </span>:{{$allOffers->price}}</p>
